...
var geminiTask = task({
  ...
  run: /* @__PURE__ */ __name(async (payload) => {
    ...
    try {
      console.log(`📡 Node [${nodeId}]: Using stable gemini-1.5-flash...`);
      const model = genAI.getGenerativeModel({
        model: "gemini-1.5-flash"
      });
      const prompt = systemPrompt ? `Instructions: ${systemPrompt}
...
@google/generative-ai/dist/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=geminiTask.mjs.map
